...
class Experiment:
    ...
    def sorted_roc_points(self) -> tuple[list[float], list[float]]:
        ...
        for condition in self.conditions:
            false_alarm_rates.append[condition.false_alarm_rate()]
            hit_rates.append[condition.hit_rate()]
        
        sorted_indices = np.argsort(false_alarm_rates)
        sorted_false_alarm_rates = false_alarm_rates[sorted_indices].tolist()
        sorted_hit_rates = hit_rates[sorted_indices].tolist()
